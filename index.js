			...
			.then((ans) => {
				...
				<div class="card bg-light shadow bg-white rounded">
					...
					<ul class="list-group list-group-flush mx-3 my-4 border">
						...
						<li class="list-group-item">Email: <a href="mailto:${manager.email}">Email: ${
					manager.email
				}</a></li>
				...
				if (answers.continue === "Engineer") {
					inquirer
						...
						<div class="card bg-light shadow bg-white rounded">
							...
							<ul class="list-group list-group-flush mx-3 my-4 border">
								...
								<li class="list-group-item">Email: <a href="mailto:${engineer.email}">Email: ${
								engineer.email
							}</a></li>
								<li class="list-group-item">GitHub: <a href="https://github.com/${
									engineer.github
								}">GitHub: ${engineer.github}</a></li>
							</ul>
						</div>
						</div>`;
							this.addMore();
					...
					<div class="card bg-light shadow bg-white rounded">
						...
						<ul class="list-group list-group-flush mx-3 my-4 border">
							...
							<li class="list-group-item">Email: <a href="mailto:${intern.email}">Email: ${
								intern.email
							}</a></li>
